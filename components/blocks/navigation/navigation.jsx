		...
		<Fragment>
			<nav className={ `navigation navigation--mobile navigation--${ renderColor() } ${ menuState === 'open' ? 'navigation--open' : '' }` }>
				<div className="navigation__bar">
					<img className="navigation__logo" src="/logos/logo-praxis-dietschiberg.svg" alt="Praxis am Dietschiberg" onClick={ () => router.push('/') } />
				...
				<div className="navigation__blocker" />
				<div className="navigation__inner">
					...
					<address className="navigation__address">
						<img className="navigation__address-icon" src="/icon/icon-location.svg" alt="Icon" />
					...
					<div className="navigation__contact">
						<img className="navigation__contact-icon" src="/icon/icon-phone.svg" alt="Icon" />
					...
					<div className="navigation__times">
						<img className="navigation__times-icon" src="/icon/icon-time.svg" alt="Icon" />
			...
			<nav className={ `navigation navigation--desktop navigation--${ renderColor() }` }>
				<div className="navigation__inner">
					<span className="navigation__size-limiter">
						<img className="navigation__logo" src="/logos/logo-praxis-dietschiberg.svg" alt="Icon" onClick={ () => router.push('/') } />
